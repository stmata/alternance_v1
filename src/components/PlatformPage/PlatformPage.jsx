...
const PlatformPage = () => {
  ...
  return (
    <Box display="flex"  className="split-view-container" padding="20px" width="100%">
      {/* Conteneur du tableau */}
      {/* Conteneur du tableau */}
{loading ? (
  <Box className="table-container">
    <Box display="flex" width="210vh" className='spinner' justifyContent="center" alignItems="center" >
...
>
  <WarningIcon sx={{ color: '#856404', fontSize: 50 }} /> {/* Icône Warning avec couleur jaune foncé */}
